     ...
     <nav className="fixed top-0 left-0 w-full bg-white shadow-md z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            >
              <FaSignInAlt className="mr-2" /> Login as Admin
            </Link>
            <Link
              to={'/login-branch'}
              className="text-gray-600 hover:text-blue-500 transition duration-300 flex items-center"
            >
              <FaSignInAlt className="mr-2" /> Login as Branch Manager
            </Link>
            <Link
              to={'/login-employee'}
              className="text-gray-600 hover:text-blue-500 transition duration-300 flex items-center"
            >
              <FaSignInAlt className="mr-2" /> Login as Employee
            </Link>
          </div>
        </div>
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-md">
            ...
            >
              <FaSignInAlt className="inline-block mr-2" /> Login as Admin
            </Link>
            <Link
              to={'/login-branch'}
              className="block px-6 py-2 text-gray-600 hover:text-blue-500"
            >
              <FaSignInAlt className="inline-block mr-2" /> Login as Branch Manager
            </Link>
            <Link
              to={'/login-employee'}
              className="block px-6 py-2 text-gray-600 hover:text-blue-500"
            >
              <FaSignInAlt className="inline-block mr-2" /> Login as Employee
            </Link>
